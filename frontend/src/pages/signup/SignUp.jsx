...
const SignUp = () => {
	...
	return (
		<div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
			<div className='w-full p-6 rounded-lg shadow-md bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-sl bg-opacity-50'>
				<h1 className='text-3xl font-bold text-center text-black '>
					SignUp <span className='text-black font-bold'> ChatApp</span>
				</h1>
				...
				<form onSubmit={handleSubmit}>
					...
					<Link
						to={"/login"}
						className='text-sm hover:underline hover:text-blue-900 mt-2 inline-block font-bold text-black '
						href='#'
					>
